...
<section>
    <div id="Organisationlist" class="container-fluid p-5">
        <h2 class="text-center p-5">Dental Hospital List</h2>
        <div class="row pb-4">
            @if (count($dentalHospitals) > 0)
                @foreach ($dentalHospitals as $hospital)
                ...
                @endforeach
            @else
                <h2 class="text-center" style="height: 60vh;">Dental Hospitals Not Found</h2>
            @endif
        </div>
    </div>
</section>
